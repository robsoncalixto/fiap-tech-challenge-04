...
- [**Haar Cascade Tutorial**](http://bogotobogo.com/python/OpenCV_Python/python_opencv3_Image_Object_Detection_Face_Detection_Haar_Cascade_Classifiers.php)
- [**DeepFace Documentation**](https://pypi.org/project/deepface/0.0.24/)
- [**face_recognition Documentation**](https://pypi.org/project/face-recognition/)